...
🔍 Аналитик → 💡 Креатор → 📝 Сценарист → 🎨 Визуальный директор
                                                     ↓
📤 Publisher ← ️ Монтажер ← 🎵 Композитор ← 🖼️ Генератор ← 🎙️ Диктор
...
### ✅ Реализовано
- [x] Multi-agent архитектура (7 агентов)
- [x] Mock-режим для тестирования без API
- [x] Генерация сценариев с субтитрами
- [x] Автоматический монтаж видео
- [x] Фоновая музыка (ambient)
- [x] Умная система сохранения результатов
- [x] Каталог всех сгенерированных идей
