...
│  🔍 TrendAnalyst                                        │
│     Вход: ниша                                          │
│     Выход: анализ трендов, потенциал, конкуренция       │
│          │                                              │
│          ▼                                              │
│  💡 IdeaGenerator                                       │
│     Вход: анализ ниши                                   │
│     Выход: 10 идей с viral score                        │
│          │                                              │
│          ▼                                              │
│  📝 ScriptWriter                                        │
│     Вход: лучшая идея                                   │
│     Выход: сценарий на 6 сцен (40 сек)                  │
└─────────────────────────────────────────────────────────┘
                          │
                          ▼
┌─────────────────────────────────────────────────────────┐
...
│  🎨 VisualDirector                                      │
│     Вход: сценарий                                      │
│     Выход: промпты для генерации картинок               │
│          │                                              │
│          ├──────────────┬──────────────┐                │
│          ▼              ▼              ▼                │
│  🖼️ ImageGen    🎙️ VoiceArtist   🎵 MusicComposer     │
│     Картинки       Озвучка         Музыка               │
│     6×PNG          6×MP3           1×WAV                │
│     1080×1920      текст→голос     ambient              │
└─────────────────────────────────────────────────────────┘
                          │
                          ▼
┌─────────────────────────────────────────────────────────┐
...
│                                                         │
│  🎞️ VideoEditor                                         │
│     Вход: картинки + озвучка + музыка                   │
│     Процесс:                                            │
│       1. Наложение субтитров на картинки                │
│       2. Создание клипов (5-8 сек каждый)               │
│       3. Добавление fade-переходов                      │
│       4. Склейка в единое видео                         │
│       5. Добавление фоновой музыки                      │
│     Выход: short_final.mp4 (1080×1920, 40 сек)          │
─────────────────────────────────────────────────────────┘
                          │
                          ▼
┌─────────────────────────────────────────────────────────┐
│  ЭТАП 4: ПУБЛИКАЦИЯ (в разработке)                      │
│                                                         │
│  📤 YouTubePublisher                                    │
│     Вход: видео + метаданные                            │
│     Процесс: загрузка на YouTube Shorts                 │
│     Выход: ссылка на опубликованное видео               │
└─────────────────────────────────────────────────────────┘
```
